...
if (!$result) {
    ...
    print "              <td><input type=\"text\" name=\"telefono\" size=\"$tamTelefono\" maxlength=\"$tamTelefono\" autofocus=\"autofocus\" /></td>\n";
    print "            </tr>\n";
    
    print "            <tr>\n";
    print "              <td>Email:</td>\n";
    print "              <td><input type=\"text\" name=\"email\" size=\"$tamEmail\" maxlength=\"$tamEmail\" autofocus=\"autofocus\" /></td>\n";
    print "            </tr>\n";
