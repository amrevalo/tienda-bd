...
-- Tiempo de generación: 14-02-2018 a las 01:12:34
...
INSERT INTO `factura` (`id`, `importe`, `fecha_factura`, `descripcion`, `forma_pago`, `observaciones`, `iva`) VALUES
(1, 89.9, '2018-01-11 00:00:00', 'Arcadia quest nuevo', 'Efectivo', NULL, 21),
(2, 23.95, '2018-01-02 00:00:00', 'nendoroid, manga', 'Tarjeta', NULL, 21);
...
(1, 'imagen hunter', 'http://localhost:8081/tienda/imagenes/tomohunterxhunter1_1.jpg', 1);
...
(1, 3, 1, 'Juego de mesa', 89.9, 1),
(2, 2, 2, 'Linea dos', 9, 2),
(3, 5, 2, 'Linea pedido 3', 15.95, 1),
(4, 5, 2, 'Linea pedido 5', 45.32, 5);
...
INSERT INTO `pedido` (`id`, `id_cliente`, `id_factura`, `descripcion`) VALUES
(1, 3, 1, 'Pedido'),
(2, 6, 2, NULL);
...
ALTER TABLE `pedido`
  ...
  ADD KEY `fk_pedido_factura1_idx` (`id_factura`);
...
ALTER TABLE `pedido`
  ...
  ADD CONSTRAINT `fk_pedido_factura1` FOREIGN KEY (`id_factura`) REFERENCES `factura` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
